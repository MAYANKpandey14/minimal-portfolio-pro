        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="https://www.linkedin.com/in/mayankpandey-21a5bb195/" target="_blank" className="p-2 rounded-full bg-background text-muted-foreground hover:text-foreground transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="https://github.com/MAYANKpandey14" target="_blank" className="p-2 rounded-full bg-background text-muted-foreground hover:text-foreground transition-colors">
